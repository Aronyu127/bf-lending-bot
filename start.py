...
# CEIL caps touch success only; keep high so spike raw is not clipped. Fallback is separate (low).
PREPOSITION_RATE_CEIL = _env_float("PREPOSITION_RATE_CEIL", 0.0050)
PREPOSITION_FALLBACK_RATE = _env_float("PREPOSITION_FALLBACK_RATE", 0.00040)
